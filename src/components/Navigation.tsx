...
const Navigation = () => {
  return (
    <nav
      className="fixed top-6 left-1/2 transform -translate-x-1/2 bg-white/30 backdrop-blur-md shadow-lg z-50 rounded-full px-14 py-3 flex items-center justify-between border border-white/40 border-opacity-30 transition-all"
      style={{ minWidth: 400, maxWidth: 620 }}
    >
      {/* Left: Home + About */}
      <div className="flex items-center space-x-7 flex-1 justify-start">
